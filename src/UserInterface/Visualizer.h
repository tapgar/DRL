...
public:
	...
	void profilerUpdateForces( Eigen::Matrix<double, nC*DOF, 1> f, Eigen::Matrix<double, nU, 1> u);
	...
	void profilerUpdateCOP(Eigen::Matrix<double, DOF, 1> COM, Eigen::Matrix<double, DOF, 1> COM_target, Eigen::Matrix<double, DOF, nC> foot, bool* bContact);
